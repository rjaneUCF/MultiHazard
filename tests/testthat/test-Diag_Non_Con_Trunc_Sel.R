...
test_that("Handles NA values", {
  ...
  expect_error(Diag_Non_Con_Trunc(Data = rep(NA, 20), x_lab = "Rainfall (Inches)", Selected="Twe"),
...
test_that("Invalid inputs produce errors", {
  ...
  expect_warning(Diag_Non_Con_Trunc(Data = data_with_inf, x_lab = "Rainfall (Inches)", Selected="Twe"),
