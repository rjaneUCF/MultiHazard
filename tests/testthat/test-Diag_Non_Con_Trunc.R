...
test_that("Diag_Non_Con_Trunc functions basic functionality", {
  ...
  result <- Diag_Non_Con_Trunc(Data=S20.OsWL$Data$Rainfall ,x_lab="Rainfall (Inches)",
...
test_that("Test the plots work", {
  expect_silent(Diag_Non_Con_Trunc(Data = S20.OsWL$Data$Rainfall , x_lab = "Rainfall (Inches)"))
})