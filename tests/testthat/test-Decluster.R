...
test_that("Declustering actually works", {
  test_vector <- S20_T_MAX_Daily_Completed_Detrend_Declustered[16719:17814,"Detrend"]
...
test_that("Handles NA values", {
  test_data_with_na <- S20_T_MAX_Daily_Completed_Detrend_Declustered[16719:17814,c("Date","Value")]
