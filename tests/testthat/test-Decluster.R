...
test_that("Declsuter functions basic functionality", {
  test_data <-S22_T_MAX_Daily_Completed_Detrend[,c(1,4)]  
  ...
  expect_false(identical(result, S22_T_MAX_Daily_Completed_Detrend[,5]))
})

# Test declustering logic
test_that("Declustering actually works", {
  test_vector <- S22_T_MAX_Daily_Completed_Detrend[,4]
...
test_that("Handles NA values", {
  test_data_with_na <- S22_T_MAX_Daily_Completed_Detrend[,c(1,2)]
