...
#Converting Date column to "Date"" object
S20.Rainfall.df$Date<-as.Date(as.character(S20.Rainfall.df$Date), format = "%Y-%m-%d")
S20.OsWL.df$Date<-as.Date(as.character(S20.OsWL.df$Date), format = "%Y-%m-%d")
```
...
S22.Detrend.df.extended$Date = as.Date(S22.Detrend.df.extended$Date, origin = "1970-01-01")
message("=== DEBUG INFO ===")
message("Structure: ", capture.output(str(S22.Detrend.df.extended[,1:3])))
message("Class of first column: ", class(S22.Detrend.df.extended[,1:3][[1]]))
message("Head: ", capture.output(head(S22.Detrend.df.extended[,1:3])))
