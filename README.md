...
```
    ...
    ##   system is computationally singular: reciprocal condition number = 5.22243e-17

    ## Error in diag(o$cov) : invalid 'nrow' value (too large or NA)

    ## Error in solve.default(family$info(o)) : 
    ##   system is computationally singular: reciprocal condition number = 9.34833e-17
    ...
    ## Error in solve.default(family$info(o)) : 
    ##   system is computationally singular: reciprocal condition number = 6.11545e-17
    ...
    ## Error in solve.default(family$info(o)) : 
    ##   system is computationally singular: reciprocal condition number = 6.38236e-17

    ## Error in diag(o$cov) : invalid 'nrow' value (too large or NA)

    ## Error in solve.default(family$info(o)) : 
    ##   system is computationally singular: reciprocal condition number = 4.81687e-17

    ## Error in diag(o$cov) : invalid 'nrow' value (too large or NA)

    ## Error in solve.default(family$info(o)) : 
    ##   system is computationally singular: reciprocal condition number = 9.17491e-17
...
interval $(u_{Y_L},F^{-1}_{Y_L}(1-p))$ where $u_{Y_L}$ is the minimal
quantile for which the fitted model is valid and $F^{-1}_{Y_L}(1-p)$ is
...
quantiles in the interval $(x^{'}**,F^{-1}_{X_L}(1-p))$ where
...
isoline with exceedance probability $p < p^{\ast}$, a set $W$ of equally
...
$w \in [0,1]$ and $t > 0$. If $u$ is the $(1-p^{\ast})^{\text{th}}$
quantile of $T_w$ i.e., $\Pr(T_w > u) = p^*$, then
...
```
    ...
    ##        Rainfall     OsWL
    ## 560    7.278122 3.749255
    ## 622    8.676729 3.542740
    ## 622.1  8.676729 3.542740
    ## 813   12.771785 2.695807
    ## 532    6.672468 3.871400
    ## 241    1.977980 5.857066
    ## 671    9.752631 3.347856
    ## 154    1.161470 6.633096
    ## 865   13.567333 2.299897
    ## 139    1.088608 6.778863
