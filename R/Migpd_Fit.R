...
#' @param penalty How the likelihood should be penalized. Defaults to \code{"gaussian"}.
#' @param maxit Numeric vector of length specifying the maximum number of iterations used in the optimization. Default is \code{10000}.
#' @param trace Default is \code{0}.
#' @param verbose Default is \code{FALSE}.
#' @param priorParameters Prior parameters. Only use if \code{penalty = "gaussian"}.
#' @return An object of class \code{"migpd"}. There are \code{coef}, \code{print}, \code{plot}, and \code{summary} functions available.
