...
#' @param Year.Initial Character vector of length one; specifying the current year.
...
#'                    Input_unit="m")
NOAA_SLR<-function(OsWL_req,SLR_scen = c("High","Intermediate","Low"),Input_unit="m",Year.Initial=2020){
