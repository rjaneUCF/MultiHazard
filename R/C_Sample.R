...
#'                            Xp=sim.peak)
C_Sample<-function(Data,Cluster_Max,D,Start,End,Xp){
  ...
  res = data.frame(Samp,d.csample,v.csample,v.net.csample,xp,I.csample,I.net,s,e)
  colnames(res) = c("Samp","D","V","Vn","Xp","I","In","Start","End")
