...
#' @param Lag_Forward_Var1 Numeric vector of length one specifying poisitve lag applied to variable in the first column of \code{Data_Detrend}. Default \code{0}.
